...
ActorBase = (function(){
  ...
  function ActorBase(){
    ...
    this$.actorId = uuid4();
    console.log('name:', this$.name, this$['receive']);
    return this$;
